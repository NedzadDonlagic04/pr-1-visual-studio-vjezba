...
void placeMaxFromBothMatrixesIntoOne(const int* const* const, const int* const* const, int**, const std::size_t, const std::size_t, const std::size_t, const std::size_t);
...
int main() {
	...
	placeMaxFromBothMatrixesIntoOne(matrix1, matrix2, matrix3, rows1, cols1, rows2, cols2);
...
void placeMaxFromBothMatrixesIntoOne(const int* const* const matrix1, const int* const* const matrix2, int** matrix3, const std::size_t rows1, const std::size_t cols1, const std::size_t rows2, const std::size_t cols2) {
	...
	for (std::size_t i = 0; i < rows3; i++) {
		for (std::size_t ii = 0; ii < cols3; ii++) {
			if (i < rows1 && ii < cols1 && i < rows2 && ii < cols2) {
				matrix3[i][ii] = std::max(matrix1[i][ii], matrix2[i][ii]);
			}
			else if (i < rows1 && ii < cols1) {
				matrix3[i][ii] = matrix1[i][ii];
			}
			else if (i < rows2 && ii < cols2) {
